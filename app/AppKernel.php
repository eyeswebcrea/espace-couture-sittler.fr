...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = array(
            ...
            new Eyeswebcrea\CatalogueBundle\EyeswebcreaCatalogueBundle(),
        	...
        	new Sittler\HomeBundle\SittlerHomeBundle(), // Bundle principale de l'application
        	new Genemu\Bundle\FormBundle\GenemuFormBundle(), // Bundle permet de gerer des extra pour les form tel que richeditor
        );
